...
<body style="background: lightcyan">
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4" style="width: 500px; height: 500px; background:lightblue">
            ...
            <form action="{{ route('valids') }}" method="POST">
                ...
                <div class="form-group mt-3">
                    <label for="konfirm">Konfirm Password</label>
                    <input type="password" class="form-control" id="konfirm" name="konfirm" required>
                </div>

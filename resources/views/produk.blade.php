...
<body style="background: lightcyan">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card" style="width: 18rem; margin-top: 20px; background:lightslategray">
                    <img src="{{ asset('storage/image/' . $produk->gambar) }}" width="100" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title" style="color: aliceblue">{{ $produk->namabunga }}</h5>
                        <p class="card-text" style="color: aliceblue">{{ $produk->deskripsi }}</p>
